...
export default function ListRoom(){
    ...
    <div>
        <Accordion style={{width: 239}} >
          ...
          <AccordionPanel>
            <AccordionTitle>Lớp Thêm Sức 2</AccordionTitle>
            <AccordionContent className="bg-slate-200">
              <p className="mb-2 text-gray-500 dark:text-gray-400">
                Sỉ Số : 100
              </p>
          ...
          <AccordionPanel>
            <AccordionTitle>Lớp Thêm Sức 3</AccordionTitle>
            <AccordionContent className="bg-slate-200">
              <p className="mb-2 text-gray-500 dark:text-gray-400">
                Sỉ Số : 100
              </p>
          ...
          <AccordionPanel>
            <AccordionTitle>Lớp Xưng Tội 4</AccordionTitle>
            <AccordionContent>
              <p className="mb-2 text-gray-500 dark:text-gray-400">
                Sỉ Số : 100
              </p>
          ...
          <AccordionPanel>
            <AccordionTitle>Lớp Thêm Sức 5</AccordionTitle>
            <AccordionContent>
              <p className="mb-2 text-gray-500 dark:text-gray-400">
                Sỉ Số : 100
              </p>
          ...
          <AccordionPanel>
            <AccordionTitle>Lớp Thêm Sức 6</AccordionTitle>
            <AccordionContent>
              <p className="mb-2 text-gray-500 dark:text-gray-400">
                Sỉ Số : 100
              </p>
          ...
          <AccordionPanel>
            <AccordionTitle>Lớp Thêm Sức 7</AccordionTitle>
            <AccordionContent>
              <p className="mb-2 text-gray-500 dark:text-gray-400">
                Sỉ Số : 100
              </p>
